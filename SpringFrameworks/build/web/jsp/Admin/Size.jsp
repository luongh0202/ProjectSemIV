                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        Danh sách khích thước
                                    </div>

                                    <div>    
                                       <table id="size" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                              <thead>
                                                <tr>
                                                   
                                                    <th>Mã kích thước</th>
                                                    <th>Tên khích thước</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${size.sizeName}</td>
                                                    <td class="hidden-480">${size.descriptions}</td>
                                                    
                                                       <c:if test="${size.status == 'True'}">
                                                         <td>
                                                            Kích hoạt
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${size.status == 'False'}">
                                                         <td>
                                                            Không kích hoạt
                                                        </td>
                                                    </c:if>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            ...
                                                            <a class="red" href="deleteSize.htm?Id= ${size.sizeId}">
